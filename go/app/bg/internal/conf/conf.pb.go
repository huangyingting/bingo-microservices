...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4a, 0x0a, 0x09, 0x42, 0x6f,
	...
	0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x22, 0xa2, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65,
	...
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x1b, 0x0a, 0x05, 0x52,
	0x65, 0x64, 0x69, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x42, 0x18, 0x5a, 0x16, 0x67, 0x65, 0x6f, 0x2f,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server)(nil),              // 1: Server
	(*Redis)(nil),               // 2: Redis
	(*Server_HTTP)(nil),         // 3: Server.HTTP
	(*Server_GRPC)(nil),         // 4: Server.GRPC
	(*durationpb.Duration)(nil), // 5: google.protobuf.Duration
}
var file_internal_conf_conf_proto_depIdxs = []int32{
	1, // 0: Bootstrap.server:type_name -> Server
	2, // 1: Bootstrap.redis:type_name -> Redis
	3, // 2: Server.http:type_name -> Server.HTTP
	4, // 3: Server.grpc:type_name -> Server.GRPC
	5, // 4: Server.HTTP.timeout:type_name -> google.protobuf.Duration
	5, // 5: Server.GRPC.timeout:type_name -> google.protobuf.Duration
