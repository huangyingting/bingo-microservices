...
type SubscriberConfig struct {
	...
	ConnectTimeout   *duration.Duration `protobuf:"bytes,14,opt,name=connect_timeout,json=connectTimeout,proto3" json:"connect_timeout,omitempty"`
	...
	RetryInterval    *duration.Duration `protobuf:"bytes,16,opt,name=retry_interval,json=retryInterval,proto3" json:"retry_interval,omitempty"`
...
func (x *SubscriberConfig) GetConnectTimeout() *duration.Duration {
	if x != nil {
...
func (x *SubscriberConfig) GetRetryInterval() *duration.Duration {
	if x != nil {
...
type PublisherConfig struct {
	...
	ConnectTimeout *duration.Duration `protobuf:"bytes,12,opt,name=connect_timeout,json=connectTimeout,proto3" json:"connect_timeout,omitempty"`
}
...
func (x *PublisherConfig) GetRetryInterval() *duration.Duration {
	if x != nil {
		return x.RetryInterval
	}
	return nil
...
func (x *PublisherConfig) GetConnectTimeout() *duration.Duration {
	if x != nil {
		return x.ConnectTimeout
	}
	return nil
