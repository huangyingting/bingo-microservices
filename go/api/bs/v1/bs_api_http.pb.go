...
const OperationShortUrlDeleteShortUrl = "/api.shorturl.v1.ShortUrl/DeleteShortUrl"
const OperationShortUrlGetShortUrl = "/api.shorturl.v1.ShortUrl/GetShortUrl"
const OperationShortUrlListShortUrl = "/api.shorturl.v1.ShortUrl/ListShortUrl"
const OperationShortUrlLiveness = "/api.shorturl.v1.ShortUrl/Liveness"
const OperationShortUrlReadiness = "/api.shorturl.v1.ShortUrl/Readiness"
const OperationShortUrlUpdateShortUrl = "/api.shorturl.v1.ShortUrl/UpdateShortUrl"
...
func _ShortUrl_UpdateShortUrl0_HTTP_Handler(srv ShortUrlHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShortUrlUpdateShortUrl)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShortUrl_ListShortUrl0_HTTP_Handler(srv ShortUrlHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShortUrlListShortUrl)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShortUrl_DeleteShortUrl0_HTTP_Handler(srv ShortUrlHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShortUrlDeleteShortUrl)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShortUrl_Liveness0_HTTP_Handler(srv ShortUrlHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShortUrlLiveness)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShortUrl_Readiness0_HTTP_Handler(srv ShortUrlHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShortUrlReadiness)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
type ShortUrlHTTPClient interface {
	...
	DeleteShortUrl(ctx context.Context, req *DeleteShortUrlRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
...
func (c *ShortUrlHTTPClientImpl) DeleteShortUrl(ctx context.Context, in *DeleteShortUrlRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/v1/shorturl/{alias}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShortUrlDeleteShortUrl))
	opts = append(opts, http.PathTemplate(pattern))
...
func (c *ShortUrlHTTPClientImpl) ListShortUrl(ctx context.Context, in *ListShortUrlRequest, opts ...http.CallOption) (*ListShortUrlResponse, error) {
	...
	pattern := "/v1/shorturl"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShortUrlListShortUrl))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShortUrlHTTPClientImpl) Liveness(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*StatusReply, error) {
	var out StatusReply
	pattern := "/healthz"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShortUrlLiveness))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShortUrlHTTPClientImpl) Readiness(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*StatusReply, error) {
	var out StatusReply
	pattern := "/readyz"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShortUrlReadiness))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShortUrlHTTPClientImpl) UpdateShortUrl(ctx context.Context, in *UpdateShortUrlRequest, opts ...http.CallOption) (*ShortUrlResponse, error) {
	...
	pattern := "/v1/shorturl"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationShortUrlUpdateShortUrl))
	opts = append(opts, http.PathTemplate(pattern))
...
const OperationCaptchaVerify = "/api.shorturl.v1.Captcha/Verify"
...
const OperationTagSuggestVerify = "/api.shorturl.v1.TagSuggest/Verify"
...
func _TagSuggest_Verify1_HTTP_Handler(srv TagSuggestHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationTagSuggestVerify)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *TagSuggestHTTPClientImpl) Verify(ctx context.Context, in *SuggestRequest, opts ...http.CallOption) (*SuggestResponse, error) {
	...
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationTagSuggestVerify))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
const OperationSystemStats = "/api.shorturl.v1.System/Stats"
const OperationSystemUpdateCpuLoad = "/api.shorturl.v1.System/UpdateCpuLoad"
const OperationSystemUpdateMemLoad = "/api.shorturl.v1.System/UpdateMemLoad"
...
func _System_UpdateMemLoad0_HTTP_Handler(srv SystemHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationSystemUpdateMemLoad)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _System_UpdateCpuLoad0_HTTP_Handler(srv SystemHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationSystemUpdateCpuLoad)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _System_Stats0_HTTP_Handler(srv SystemHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationSystemStats)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.Stats(ctx, req.(*empty.Empty))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type SystemHTTPClient interface {
	Stats(ctx context.Context, req *empty.Empty, opts ...http.CallOption) (rsp *StatsResponse, err error)
	UpdateCpuLoad(ctx context.Context, req *CpuLoadRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
	UpdateMemLoad(ctx context.Context, req *MemLoadRequest, opts ...http.CallOption) (rsp *empty.Empty, err error)
}
...
func (c *SystemHTTPClientImpl) Stats(ctx context.Context, in *empty.Empty, opts ...http.CallOption) (*StatsResponse, error) {
	var out StatsResponse
	pattern := "/v1/system/stats"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationSystemStats))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *SystemHTTPClientImpl) UpdateCpuLoad(ctx context.Context, in *CpuLoadRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/v1/system/cpu"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationSystemUpdateCpuLoad))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "PUT", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *SystemHTTPClientImpl) UpdateMemLoad(ctx context.Context, in *MemLoadRequest, opts ...http.CallOption) (*empty.Empty, error) {
	var out empty.Empty
	pattern := "/v1/system/mem"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationSystemUpdateMemLoad))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in, &out, opts...)
	if err != nil {
		return nil, err
...
const OperationShortUrlBIClicks = "/api.shorturl.v1.ShortUrlBI/Clicks"
...
func _ShortUrlBI_Clicks0_HTTP_Handler(srv ShortUrlBIHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShortUrlBIClicks)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ShortUrlBIHTTPClientImpl) Clicks(ctx context.Context, in *ClicksRequest, opts ...http.CallOption) (*ClicksReply, error) {
	...
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShortUrlBIClicks))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
