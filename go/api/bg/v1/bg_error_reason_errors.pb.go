...
func IsInvalidIpAddress(err error) bool {
	...
	return e.Reason == ErrorReason_INVALID_IP_ADDRESS.String() && e.Code == 400
}

func ErrorInvalidIpAddress(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_INVALID_IP_ADDRESS.String(), fmt.Sprintf(format, args...))
}
...
func IsLocationNotFound(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_LOCATION_NOT_FOUND.String() && e.Code == 404
}

func ErrorLocationNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, ErrorReason_LOCATION_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
